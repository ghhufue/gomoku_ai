...
ext_modules = [
    Extension(
        ...
        [
            "cpp/RewardEvaluator.cpp",
            "cpp/GameStateStore.cpp",
            "cpp/RewardConfigStore.cpp",
            "cpp/StateValueRegistry.cpp",
            "cpp/direction_encoding.cpp",
            "cpp/utils/direction_pattern_lookup.cpp",
            "cpp/precompute/DirectionDeltaTable.cpp",
        ],
